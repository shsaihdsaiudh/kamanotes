...
-- 作者：t
-- 日期：2025-04-18
-- 功能：合并所有表定义，并修复 optimize_search.sql 中的问题

-- ------------- 笔记评论表 (V20240320_1) -------------
CREATE TABLE IF NOT EXISTS note_comment (
    note_comment_id INT PRIMARY KEY AUTO_INCREMENT COMMENT '笔记评论ID',
    note_id INT NOT NULL COMMENT '笔记ID',
    user_id BIGINT NOT NULL COMMENT '用户ID',
    content TEXT NOT NULL COMMENT '评论内容',
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    is_deleted BOOLEAN NOT NULL DEFAULT FALSE COMMENT '是否删除: 0-否, 1-是'
